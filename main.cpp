...
// Function prototypes
vector<string> get_database_files(); // Gets all the database files in the Data folder
string choose_database(vector<string> database_files); // Allows user to choose a database file
...
// Gets all the database files in the Data folder
...
// Allows user to choose a database file
